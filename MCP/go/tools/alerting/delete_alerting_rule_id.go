...
func Delete_alerting_rule_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_alerting_rule_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_alerting_rule_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_alerting_rule_idHandler(cfg),
	}
}

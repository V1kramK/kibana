...
func Put_fleet_outputs_outputidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_fleet_outputs_outputidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_fleet_outputs_outputId",
		mcp.WithDescription("Update output"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_fleet_outputs_outputidHandler(cfg),
	}
}

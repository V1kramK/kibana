...
func Delete_fleet_outputs_outputidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/fleet/outputs/%s", cfg.BaseURL, outputId)
...
func CreateDelete_fleet_outputs_outputidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_fleet_outputs_outputId",
		mcp.WithDescription("Delete output"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_fleet_outputs_outputidHandler(cfg),
	}
}

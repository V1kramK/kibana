...
func Delete_security_role_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/security/role/%s", cfg.BaseURL, name)
...
func CreateDelete_security_role_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_security_role_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_security_role_nameHandler(cfg),
	}
}

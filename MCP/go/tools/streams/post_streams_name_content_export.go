...
func Post_streams_name_content_exportHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/streams/%s/content/export", cfg.BaseURL, name)
...
func CreatePost_streams_name_content_exportTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_streams_name_content_export",
		mcp.WithDescription("Export stream content"),
		...
		mcp.WithObject("include", mcp.Required(), mcp.Description("")),
		mcp.WithString("name", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Post_streams_name_content_exportHandler(cfg),
	}
}

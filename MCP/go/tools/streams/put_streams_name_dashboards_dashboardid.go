...
func Put_streams_name_dashboards_dashboardidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_streams_name_dashboards_dashboardidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_streams_name_dashboards_dashboardId",
		mcp.WithDescription("Link a dashboard to a stream"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_streams_name_dashboards_dashboardidHandler(cfg),
	}
}

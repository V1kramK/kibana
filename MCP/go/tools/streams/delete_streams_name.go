...
func Delete_streams_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/streams/%s", cfg.BaseURL, name)
...
func CreateDelete_streams_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_streams_name",
		mcp.WithDescription("Delete a stream"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_streams_nameHandler(cfg),
	}
}

...
func Post_streams_name_dashboards_bulkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/streams/%s/dashboards/_bulk", cfg.BaseURL, name)
...
func CreatePost_streams_name_dashboards_bulkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_streams_name_dashboards__bulk",
		mcp.WithDescription("Bulk update dashboards"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_streams_name_dashboards_bulkHandler(cfg),
	}
}

...
func Put_streams_name_ingestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/streams/%s/_ingest", cfg.BaseURL, name)
...
func CreatePut_streams_name_ingestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_streams_name__ingest",
		mcp.WithDescription("Update ingest stream settings"),
		...
		mcp.WithObject("ingest", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Put_streams_name_ingestHandler(cfg),
	}
}

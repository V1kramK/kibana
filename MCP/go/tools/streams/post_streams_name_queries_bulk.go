...
func Post_streams_name_queries_bulkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/streams/%s/queries/_bulk", cfg.BaseURL, name)
...
func CreatePost_streams_name_queries_bulkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_streams_name_queries__bulk",
		mcp.WithDescription("Bulk update queries"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_streams_name_queries_bulkHandler(cfg),
	}
}

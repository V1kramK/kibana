...
func Put_streams_nameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_streams_nameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_streams_name",
		mcp.WithDescription("Create or update a stream"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_streams_nameHandler(cfg),
	}
}

...
func Delete_streams_name_dashboards_dashboardidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/streams/%s/dashboards/%s", cfg.BaseURL, name, dashboardId)
...
func CreateDelete_streams_name_dashboards_dashboardidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_streams_name_dashboards_dashboardId",
		mcp.WithDescription("Unlink a dashboard from a stream"),
		...
		mcp.WithString("dashboardId", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Delete_streams_name_dashboards_dashboardidHandler(cfg),
	}
}

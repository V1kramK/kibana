...
func Get_streams_name_significant_eventsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/streams/%s/significant_events%s", cfg.BaseURL, name, queryString)
...
func CreateGet_streams_name_significant_eventsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_streams_name_significant_events",
		mcp.WithDescription("Read the significant events"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_streams_name_significant_eventsHandler(cfg),
	}
}

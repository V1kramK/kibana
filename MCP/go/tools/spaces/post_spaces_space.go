...
func Post_spaces_spaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/spaces/space", cfg.BaseURL)
...
func CreatePost_spaces_spaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_spaces_space",
		mcp.WithDescription("Create a space"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_spaces_spaceHandler(cfg),
	}
}

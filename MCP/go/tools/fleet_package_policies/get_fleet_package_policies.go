...
func Get_fleet_package_policiesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/fleet/package_policies%s", cfg.BaseURL, queryString)
...
func CreateGet_fleet_package_policiesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_fleet_package_policies",
		mcp.WithDescription("Get package policies"),
		...
		mcp.WithBoolean("withAgentCount", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Get_fleet_package_policiesHandler(cfg),
	}
}

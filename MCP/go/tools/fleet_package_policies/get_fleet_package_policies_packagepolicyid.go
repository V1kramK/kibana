...
func Get_fleet_package_policies_packagepolicyidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_fleet_package_policies_packagepolicyidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_fleet_package_policies_packagePolicyId",
		mcp.WithDescription("Get a package policy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_fleet_package_policies_packagepolicyidHandler(cfg),
	}
}

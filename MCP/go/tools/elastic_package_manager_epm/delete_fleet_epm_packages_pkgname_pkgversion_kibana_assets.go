...
func Delete_fleet_epm_packages_pkgname_pkgversion_kibana_assetsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_fleet_epm_packages_pkgname_pkgversion_kibana_assetsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_fleet_epm_packages_pkgName_pkgVersion_kibana_assets",
		mcp.WithDescription("Delete Kibana assets for a package"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_fleet_epm_packages_pkgname_pkgversion_kibana_assetsHandler(cfg),
	}
}

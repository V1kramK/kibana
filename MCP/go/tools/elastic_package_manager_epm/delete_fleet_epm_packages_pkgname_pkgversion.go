...
func Delete_fleet_epm_packages_pkgname_pkgversionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_fleet_epm_packages_pkgname_pkgversionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_fleet_epm_packages_pkgName_pkgVersion",
		mcp.WithDescription("Delete a package"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_fleet_epm_packages_pkgname_pkgversionHandler(cfg),
	}
}

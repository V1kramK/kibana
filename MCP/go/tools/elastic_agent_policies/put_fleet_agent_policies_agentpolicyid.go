...
func Put_fleet_agent_policies_agentpolicyidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/fleet/agent_policies/%s%s", cfg.BaseURL, agentPolicyId, queryString)
...
func CreatePut_fleet_agent_policies_agentpolicyidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_fleet_agent_policies_agentPolicyId",
		mcp.WithDescription("Update an agent policy"),
		...
		mcp.WithBoolean("bumpRevision", mcp.Description("")),
		mcp.WithString("inactivity_timeout", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Put_fleet_agent_policies_agentpolicyidHandler(cfg),
	}
}

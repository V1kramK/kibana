# Kibana HTTP APIs MCP Server

This MCP (Model Content Protocol) server provides access to Kibana HTTP APIs API functionality through HTTP, HTTPS, and STDIO transport modes.
